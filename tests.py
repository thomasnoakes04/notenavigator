...
class TestScales(unittest.TestCase):
    def test_major_scales(self):
        ...
        self.assertEqual(get_scale('F', 'major'), ['F', 'G', 'A', 'A#', 'C', 'D', 'E', 'F'])
        self.assertEqual(get_scale('G', 'major'), ['G', 'A', 'B', 'C', 'D', 'E', 'F#', 'G'])
        self.assertEqual(get_scale('A#', 'major'), ['A#', 'C', 'D', 'D#', 'F', 'G', 'A', 'A#'])

    def test_harmonic_minor_scales(self):
        self.assertEqual(get_scale('A', 'harmonic minor'), ['A', 'B', 'C', 'D', 'E', 'F', 'G#', 'A'])
        self.assertEqual(get_scale('C', 'harmonic minor'), ['C', 'D', 'D#', 'F', 'G', 'G#', 'B', 'C'])
        self.assertEqual(get_scale('G#', 'harmonic minor'), ['G#', 'A#', 'B', 'C#', 'D#', 'E', 'G', 'G#'])
        self.assertEqual(get_scale('B', 'harmonic minor'), ['B', 'C#', 'D', 'E', 'F#', 'G', 'A#', 'B'])
